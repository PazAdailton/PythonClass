...
class ParsedItemLocators:
    ...
    This allows us to easily see what our code will be looking at as well as change
    it quickly if we notice it is now different
...
class ParsingItem():
    ...
    def price(self):
        ...
        price_rgex = r'\£([0-9]+\.[0-9]+)'
        match_price = re.search(price_rgex, item_price)
        #print(match_price.group(0))
        return float(match_price.group(1)) * 2
